...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (lsp-mode rustic which-key use-package tide smex rjsx-mode rainbow-delimiters racer powerline neotree magit lsp-ui general flycheck-rust expand-region exec-path-from-shell evil editorconfig dashboard counsel-projectile company-lsp cargo avy))))
(custom-set-faces
